...
Usage:
    uv run python step_04_preference_optimization/train_preference.py \
        --method dpo \
...
try:
    from step_04_preference_optimization.chat_formatting import normalize_explicit_preference_example
    from step_04_preference_optimization.trl_compat import patch_trl_optional_dependency_checks
